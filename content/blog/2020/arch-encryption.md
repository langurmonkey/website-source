...
If you are using ethernet, you probably already have a connection. If you are using wifi, use the following to configure it.
...
Now, uncomment your locale and generate it.

```bash
$  # uncomment your locale in the following file
$  nvim /etc/locale.gen
$  locale-gen
```
